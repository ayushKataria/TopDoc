...
// function forgetMail(tag, data) {
//   console.log("outside if");
//   if (tag.includes("forgetPassword")) {
//     //   console.log("inside forget mail");
...
//     //         }
//     //     </script>
//     // <p><a href={{resetLink}} onclick="clickAndDisable(this);">Reset Link</a></p>
//     //   <p>This link will expire once you click on it. If you do not reset your password once you click on the link, you will need to request another reset link.</p>`;
...
//   // resetLink = `http://localhost:4200/signUp/changePwd?docId=${data.id}`;
//   resetLink = link.concat(data.id);
// } else {
